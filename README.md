...
- 송정은 다대포와 다르게 썰물을 무조건 좋게 보지 않습니다. 들물 중반~만조 전을 우선하고, 물이 많이 빠진 시간대는 작은 파도에서 라이딩 길이를 보수적으로 봅니다.
- S~SE 스웰은 안정적으로 보고, E/ENE 스웰은 커뮤니티 체감 가설로 열어두되 실제 파고와 주기, 물때가 받쳐줄 때만 가산합니다.
- NE 스웰은 방파제와 지형 영향으로 차트보다 약할 수 있어 감점합니다.
- 8초 이상 주기는 긍정적으로 보지만, 1m 이상 파고와 5~7초 짧은 주기가 겹치면 덤프성 파도 가능성으로 점수 상한을 둡니다.
- 0.8m 미만 + 간조/물이 빠진 시간대는 2026년 6월 8일 라스트웨이브 현장 후기처럼 “작고 힘 없음, 라이딩 짧음”으로 보수적으로 설명합니다.
- 바람은 W/NW 약풍 또는 무풍권을 좋게 보고, E/SE 온쇼어는 면 깨짐, 닫힘, 백워시 가능성으로 감점합니다.
- 송정은 `songjeong_level`과 `dump_risk`를 분리해서 표시합니다. 좋은 점수라도 덤프 위험이 있으면 경고 문구를 함께 보여줍니다.

2026년 6월 8일 현장 검증:

- 송정 라스트웨이브 14:00~16:00 입수.
- 실제 체감은 파도가 너무 작고 힘이 없었으며, 초보자용 밀어타기 정도 파도만 몇 개 들어왔습니다.
- 물이 많이 빠져 라이딩이 길게 이어지지 않았고, 파도가 작아 덤프 위험은 거의 없었습니다.
- WSB FARM은 해당일을 좋게 봤지만 현장 체감과는 맞지 않았고, 섭힙의 낮은 오후 판정이 더 가까웠습니다.
- 비가 오는 날은 수온이 20~21도여도 3mm가 조금 춥게 느껴질 수 있어, 비 예보가 있으면 보온/여벌 옷을 함께 권장합니다.
